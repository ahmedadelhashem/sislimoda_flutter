...
@RoutePage()
class AddProductsNewScreen extends StatefulWidget {
  const AddProductsNewScreen({super.key});

  @override
  State<AddProductsNewScreen> createState() => _AddProductsNewScreenState();
}

class _AddProductsNewScreenState extends State<AddProductsNewScreen>
    with AddProductData {
  ...
  final isTurkish = Localizations.localeOf(context).languageCode == 'tr';
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: AppButton(
                            ...
                            title: isArabic ? 'طلب المساعدة' : isTurkish? 'Yardım iste':'Need help',
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            isArabic
                                ? 'اضف صورة العرض الرئيسية':isTurkish  ? 'Dışa aktarma ana görüntüsünü ekleyin' :
    ...
    : isTurkish
        ...
        : 'More photo details',
                          ...
                          Text(
                            isArabic
                                ? 'اضف صور المنتج / يجب مراعاه حجم الصور ليكون 500 طول * 350 عرض ومضاعفاتها' : isTurkish? 'Logoyu ekleyin / Logonun boyutunun 300 uzunluk * 500 genişlik ve katları olması gerekir' 
                    ...
                    GenericBuilder(
                        ...
                        builder: (options) {
                          ...
                          List<ProductModelProductOptionsOption>
                              selectedOptions = [];
...
isArabic
  ...
  : isTurkish
    ? 'Mevcut renkler, bedenler ve diğer seçenekler'
  ...
  : isTurkish
    ...
    : "Select Color",
                                                                ...
                                                                ? Container(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      decoration:
                                                                          BoxDecoration(
                                                                        color: Color(
                                                                            int.parse('0xff${colors[index].other?.substring(1)}')),
                                                                        borderRadius:
                                        ...
                                        if (sizes.isNotEmpty)
                                          Text(
                                            isArabic
                                                ? 'إختر الحجم' :isTurkish? 'Beden Seç'
                                                : "Select Size",
                                            style: AppFonts.apptextStyle
                                                .copyWith(
                                                    color: Colors.black,
                    ...
                    Text(
                      isArabic
                          ? "عدد المتوفر لديك في المخزن / المستودع من هذا المنتج" : isTurkish
                          ? "Bu üründen stok/depoda kaç adet var?"
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            isArabic
                                ? 'في حالة لم تلتزم بتوفير المنتج بعد دفع العميل للأموال سوف يتم خصم 30% من قيمة المنتج لصالح النظام' : isTurkish
                                ? 'Müşteri parayı ödedikten sonra ürünü sağlamazsanız, 30% ürün bedeli sistem lehine kesilecektir.'
                    ...
                    Text(
                      isArabic ? "ملاحظات" : isTurkish ? 'Notlar' :
                       "Notes",
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            isArabic
                                ? '1-  تابع جميع الطلبات من العملاء في خانة استلام طلبات العملاء في الصفحة الرئيسية' : isTurkish
                                ? '1- Müşteri Taleplerini Ana Sayfadaki Müşteri Talepleri bölümünde takip edin.'
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: AppButton(
                            ...
                            title: isArabic ? 'لاحقا' : isTurkish ? 'Sonra' :
                             'later',
