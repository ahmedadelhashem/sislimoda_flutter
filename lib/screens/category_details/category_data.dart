    ...
    try {
      ...
      result.fold((success) {
        ...
        offers.removeWhere((element) {
          print('element.offerCategory?.id${element.offerCategoryId}');
          print(element.offerCategoryId != categoryId);
          return element.offerCategoryId != categoryId;
        });
